...
const NextSectionLeft = ({ next }) => {
  return (
    <ViroButton
      source={require('../res/btn/sweet/active-left.png')}
      onClick={next}
      gazeSource={require('../res/btn/sweet/hover-left.png')}
      position={[-5, 4.5, -7]}
      rotation={[40, 20, 0]}
      scale={[1, 1, 1]}
      width={5.57}
...
const NextSectionRight = ({ next }) => {
  return (
    <ViroButton
      source={require('../res/btn/bakaleya/active-right.png')}
      onClick={next}
      gazeSource={require('../res/btn/bakaleya/hover-right.png')}
      position={[5, 4.5, -7]}
      rotation={[40, -20, 0]}
      scale={[1, 1, 1]}
      width={5.57}
...
export default function DrinksScene({ sceneNavigator }) {
  ...
  return (
    <ViroARScene>
      ...
      <Viro360Image
        ...
        source={require('../res/scenes/drinks.jpeg')}
      ...
      <NextSectionRight next={() => sceneNavigator.jump({ scene: GroceryScene })} />
